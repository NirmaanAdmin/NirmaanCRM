                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content mtop20">
                                        ...
                                        <div class="media callback-note">
                                            ...
                                            <div class="media-body">
                                                <?php if (
                                                    ...
                                                    <a href="#" class="pull-right mright5" onclick="toggle_edit_note(<?php echo $note['id']; ?>);return false;"><i class="fa fa-pencil-square"></i></a>
                                                <?php } ?>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="tab_general_information">
                                ...
                                ?>
                                <p>
                                    <i class="fa fa-user fa-fw fa-lg" aria-hidden="true"></i><strong> <?= _l('callbacks_m_name'); ?></strong><?= $callback['firstname'] . ' ' . $callback['lastname']; ?>
                                </p>
                                <hr>
                                ...
                                <div class="callbacks_assignees_wrapper assigned_users_data">
                                    <h4 class="task-info-heading font-normal font-medium-xs"><i class="fa fa-user" aria-hidden="true"></i> <?php echo _l('callbacks_table_assigned_to'); ?></h4>
