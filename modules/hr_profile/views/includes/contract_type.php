				...
				<tr>
					...
					<td>
						<?php if(is_admin() || has_permission('hrm_setting','','edit')){ ?>
							<a href="#" onclick="edit_contract_type(this,<?php echo html_entity_decode($c['id_contracttype']); ?>); return false"  class="btn btn-default btn-icon"><i class="fa fa-pencil-square"></i></a>
						<?php } ?>
