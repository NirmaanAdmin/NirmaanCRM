                ...
                <?php if($value['people_handle_id'] == get_staff_user_id() || is_admin() || has_permission('hrm_setting','','create') || has_permission('hrm_setting','','edit')){?>
                  ...
                  <div class="col-md-1">
                    ...
                    <?php if(is_admin() || has_permission('hrm_setting','','edit')) {?>
                      <a href="#" onclick="edit_procedure_retire(this); " data-id="<?php echo html_entity_decode($value['id']); ?>" class=" pull-right btn btn-warning btn-icon"><i class="fa fa-pencil-square"></i></a>
                    <?php } ?>
