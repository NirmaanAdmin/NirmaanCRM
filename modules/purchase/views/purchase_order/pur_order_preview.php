            ...
            <div class="col-md-8">
               ...
               <?php if($estimate->approve_status != 2){ ?>
                  <div class="pull-right _buttons mright5">
                     ...
                     <a href="<?php echo admin_url('purchase/pur_order/'.$estimate->id); ?>" class="btn btn-default btn-with-tooltip" data-toggle="tooltip" title="<?php echo _l('edit_pur_order_tooltip'); ?>" data-placement="bottom"><i class="fa fa-pencil-square"></i></a>
                     <?php } ?>
