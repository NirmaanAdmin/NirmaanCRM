                    ...
                    <tr>
                       ...
                       <td>
                        <?php if(is_admin() || has_permission('staffmanage_approval','','edit') ){ ?>
                         <a href="<?php echo admin_url('timesheets/edit_approval_setting/'.$value['id']); ?>" data-name="<?php echo html_entity_decode($value['name']); ?>" data-related="<?php echo html_entity_decode($value['related']); ?>" data-setting='<?php echo html_entity_decode($value['setting']); ?>' class="btn btn-default btn-icon"><i class="fa fa-pencil-square"></i></a>
                        <?php } ?>
